let project_name = 'arteco-decorative-elements';
...
let config = (function(){
	...
	return {
		...
		/***********************************************************************/
		text_domain: '' || project_name, // Example: 'ade' #lowercase, separated by underscore or dash ( _ or - )
		packageName: '' || project_name, // Example: 'ade package' #Capitalized
